...
try:
    ...
    try:
        ...
        URL = ('{}/_apis/graph/groups/{}?api-version=5.0-preview.1'
               .format(ARGS.organization, GROUP_DESCRIPTOR))
        HEADERS = {
            'Content-Type': 'application/json',
        }
        ...
        try:
            ...
            if RESPONSE_CODE == 204:
                ...
                print(f'##vso[task.logissue type=error] {ARGS.groupName} group has not been deleted successfully')
                sys.exit(1)
